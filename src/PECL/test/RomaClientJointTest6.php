 ...
 */
class RomaClientJointTest6 extends PHPUnit_Framework_TestCase
{
   ...
   * No.
   */
  public function testRomaStopSetGetDelete() {
    ...
    for ($i = 0; $i < 10000; $i++) {
      ...
      try {
        $roma_client->set("test-join-get".$i, "test-join-get".$i, 0);
        $roma_client->get("test-join-get".$i);
        $roma_client->delete("test-join-get".$i);
      } catch (Exception $e) {
        $flg = False;
        break;
      }
