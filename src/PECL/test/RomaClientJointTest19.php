 ...
 */
class RomaClientJointTest20 extends PHPUnit_Framework_TestCase
{
   ...
   * No.
   */
  public function testRomaStopAlistUpdateAt() {
    ...
    for ($i = 0; $i < 100; $i++) {
      ...
      try {
        $roma_client->alist_update_at("test-join-alist", 0, "test-join-alist".$i);
      } catch (Exception $e) {
        $flg = False;
        break;
      }
