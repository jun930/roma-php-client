 ...
 */
class RomaClientJointTest15 extends PHPUnit_Framework_TestCase
{
   ...
   * No.
   */
  public function testRomaStopAlistDelete() {
    ...
    for ($i = 0; $i < 50; $i++) {
      ...
      try {
        $roma_client->alist_delete("test-join-alist", "test-join-alist".$i);
      } catch (Exception $e) {
        $flg = False;
        break;
      }
