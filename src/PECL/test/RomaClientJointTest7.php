 ...
 */
class RomaClientJointTest7 extends PHPUnit_Framework_TestCase
{
   ...
   * No.
   */
  public function testRomaStopIncDec() {
    ...
    for ($i = 0; $i < 10000; $i++) {
      ...
      try {
        $roma_client->set("test-join-incdec", "0", 100);
        $roma_client->incr("test-join-incdec", 1);
        $roma_client->decr("test-join-incdec", 1);
      } catch (Exception $e) {
        $flg = False;
        break;
      }
